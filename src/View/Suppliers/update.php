      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card-style mb-30">
            <h6 class="mb-25">Remplissez les champs ci-après pour mettre à jour le fournisseur</h6>
            ...
            <form method="post" action="" id="quickForm">
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6 mb-2">
                    <label>Nom</label>
                    <input type="text" name="name" class="form-control" value="<?= isset($form_data['name']) ? $form_data['name'] : $supplier->getName() ?>" autocomplete="off">
                  </div>
                  <div class="form-group col-md-6 mb-2">
                    <label>Phone</label>
                    <input type="text" name="phone" class="form-control" value="<?= isset($form_data['phone']) ? $form_data['phone'] : $supplier->getPhone() ?>" data-inputmask='"mask": "+(237) 699-999-999"' data-mask>
                  </div>
                  <div class="form-group col-md-6 mb-2">
                    <label>Email</label>
                    <input type="text" name="email" placeholder="example@gmail.com" value="<?= isset($form_data['email']) ? $form_data['email'] : $supplier->getEmail() ?>" class="form-control" autocomplete="off">
                  </div>
                  <div class="form-group col-md-6 mb-2">
                    <label>Ville / Localité </label>
                    <input type="text" name="ville" class="form-control" value="<?= isset($form_data['ville']) ? $form_data['ville'] : $supplier->getVille() ?>" autocomplete="off">
                  </div>
                  <div class="form-group col-md-12 mb-2">
                    <label>Nom d'utilisateur</label>
                    <input type="text" name="username" class="form-control" value="<?= isset($form_data['username']) ? $form_data['username'] : $supplier->getUsername() ?>" autocomplete="off">
                  </div>
                  <div class="form-group col-md-6 mb-2">
              ...
              <div class="col-6 mb-3">
                ...
                <input type="submit" class="btn btn-primary" value="Enregistrer" name="update_supplier">
              </div>
            </form>
