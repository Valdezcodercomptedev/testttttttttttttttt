      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="title mb-30">
            <h2>Mettre à jour le service</h2>
          </div>
        </div>
        <!-- end col -->
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card-style mb-30">
            <h6 class="mb-25">Remplissez les champs ci-après pour mettre à jour  un service</h6>
            ...
            <form method="post" action="" id="quickForm">
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6 mb-2">
                    <label>Libellé</label>
                    <input type="text" name="libelle" class="form-control" value="<?= isset($form_data['libelle']) ? $form_data['libelle'] : $service->getLibelle() ?>" autocomplete="off">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
              <div class="col-6 mb-3">
                ...
                <input type="submit" class="btn btn-primary" value="Enregistrer" name="update_service">
...
<script>
  $(function() {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        name: {
          required: "Veuillez entrer le libellé du service.",
